...
public class DriveSubsystem extends SubsystemBase implements AutoCloseable {
  ...
  public void periodic() {
    ...
    m_odometry.update(io.getHeading(), io.getModulePositions());
  ...
  public void resetOdometry(Pose2d pose) {
    m_odometry.resetPosition(io.getHeading(), io.getModulePositions(), pose);
  }
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative, boolean rateLimit) {
    ...
    var swerveModuleStates = DriveConstants.kDriveKinematics.toSwerveModuleStates(
        fieldRelative
            ? ChassisSpeeds.fromFieldRelativeSpeeds(xSpeedDelivered, ySpeedDelivered, rotDelivered, io.getHeading())
  ...
  public void setModuleStates(SwerveModuleState[] desiredStates) {
    io.setDesiredModuleStates(desiredStates);
  }
